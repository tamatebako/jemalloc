...
* *Native CMake build system* - All ~205 CI jobs use CMake (no autotools)
...
** Level 1: Fast smoke tests (~15 jobs including musl, ~2-3 minutes)
** Level 2: Comprehensive testing (~190+ jobs covering all configure flag combinations, ~30-45 minutes)
