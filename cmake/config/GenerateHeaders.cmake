...
bool_to_int(JEMALLOC_GCC_ATOMIC_INTRINSICS)
bool_to_int(JEMALLOC_GCC_SYNC_INTRINSICS)
...
if(JEMALLOC_GCC_ATOMIC_INTRINSICS)
    string(REGEX REPLACE "#undef JEMALLOC_GCC_ATOMIC_INTRINSICS\n" "#define JEMALLOC_GCC_ATOMIC_INTRINSICS 1\n" INTERNAL_DEFS_CONTENT "${INTERNAL_DEFS_CONTENT}")
endif()
if(JEMALLOC_GCC_SYNC_INTRINSICS)
    string(REGEX REPLACE "#undef JEMALLOC_GCC_SYNC_INTRINSICS\n" "#define JEMALLOC_GCC_SYNC_INTRINSICS 1\n" INTERNAL_DEFS_CONTENT "${INTERNAL_DEFS_CONTENT}")
endif()
